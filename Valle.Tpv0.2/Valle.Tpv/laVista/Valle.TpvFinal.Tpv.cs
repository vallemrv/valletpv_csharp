...
namespace Valle.TpvFinal
{
	public partial class Tpv
	{
		...
		protected virtual void Build ()
		{
			...
			this.Name ="Valle.Tpv.iconos.Tpv";
			...
			w19.Pixbuf = Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.ERASE00C.ICO");
			w18.Add (w19);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			...
			w28.Pixbuf = Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.Backspace.ICO");
			w27.Add (w28);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			...
			w38.Pixbuf = Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.CASH01B.ICO");
			w37.Add (w38);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			...
			w47.Pixbuf = Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.NET14.ICO");
			w46.Add (w47);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			...
			w58.Pixbuf = Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.{{F02B.ICO");
			w57.Add (w58);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			...
			this.image14.Pixbuf = global::Stetic.IconLoaderEx.LoadIcon (this, "gtk-print", global::Gtk.IconSize.Dialog);
			...
			w71.Pixbuf =Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.TABLE00B.ICO");
			w70.Add (w71);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			...
			w80.Pixbuf = Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.configure_toolbars.gif");
			w79.Add (w80);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			...
			w89.Pixbuf = Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.exit.gif");
			w88.Add (w89);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			...
			w98.Pixbuf = Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.ALPH03A.ICO");
			w97.Add (w98);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			...
			w107.Pixbuf = Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.euro.png");
			w106.Add (w107);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			...
			this.image18.Pixbuf = Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.STARTUP.ICO");
			...
			this.image17.Pixbuf =  Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.Comment.ico");
			...
			this.image16.Pixbuf = global::Stetic.IconLoaderEx.LoadIcon (this, "gtk-find", global::Gtk.IconSize.Dialog);
			...
			w137.Pixbuf =  Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.ARROW12Dx.ICO");
			w136.Add (w137);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			...
			w146.Pixbuf = Gdk.Pixbuf.LoadFromResource("Valle.Tpv.iconos.ARROW12Ax.ICO");
			w145.Add (w146);
			// Container child GtkHBox.Gtk.Container+ContainerChild
