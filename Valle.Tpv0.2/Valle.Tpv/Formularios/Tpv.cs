...
{
	public enum AccionesTpv { abrirCajon, herramietas, salir, mesas, tiempoEspirado,camareros, ventaPorKilos, llenarLinea, cobrar, BorrarLinea,
	...
	public partial class Tpv : Gtk.Window
	{
        ...
        protected virtual void OnBtnAbrirCajonClicked (object sender, System.EventArgs e)
		{
			 ...
			 if(eventTpv!=null){
				eventTpv(this, new EventTpv(AccionesTpv.abrirCajon));
			}
		}
